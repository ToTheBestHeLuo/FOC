...
int main(void)
{
  ...
  LL_DAC_ConvertData12RightAligned(DAC1,LL_DAC_CHANNEL_1,2500);
  ...
  // LL_DMA_ConfigAddresses(DMA2,LL_DMA_CHANNEL_1,(uint32_t)&SPI3->DR,(uint32_t)&pAbs->encoderOutput,LL_DMA_DIRECTION_PERIPH_TO_MEMORY);
...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Pin = ADC1_VoltageA_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC1_VoltageA_GPIO_Port, &GPIO_InitStruct);
...
static void MX_ADC2_Init(void)
{
  ...
  PA7   ------> ADC2_IN4
  */
  GPIO_InitStruct.Pin = ADC2_VoltageB_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC2_VoltageB_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = ADC2_VoltageC_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC2_VoltageC_GPIO_Port, &GPIO_InitStruct);
...
static void MX_SPI3_Init(void)
{
  ...
  */
  ...
  /* SPI3_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_1, LL_DMAMUX_REQ_SPI3_RX);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  GPIO_InitStruct.Pin = GPIO_MC_SS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIO_MC_SS_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(TIM3_Zindex_GPIO_Port, TIM3_Zindex_Pin, LL_GPIO_PULL_DOWN);

  /**/
  LL_GPIO_SetPinMode(TIM3_Zindex_GPIO_Port, TIM3_Zindex_Pin, LL_GPIO_MODE_INPUT);
